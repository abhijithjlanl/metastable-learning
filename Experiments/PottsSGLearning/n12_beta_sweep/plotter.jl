...
energy_exact = energy_exact[1:n_done, :]
energy_rand  = energy_rand[1:n_done, :]
energy_min   = energy_min[1:n_done, :]
...
# Save
# ---------------------------------------------------------------
outpdf = joinpath(SCRIPT_DIR, "n12_24_beta_sweep.pdf")
savefig(fig, outpdf)
